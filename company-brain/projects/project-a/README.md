...
- [ ] Carson: review whether this Project A structure is easy to understand.
- [ ] John: test the project flow and give input.
- [ ] Agent: use this project file as the source of truth when answering questions about Project A.
...
- More real testing from Carson and John is needed before adding complexity.
